...
angular.module('citizen-engagement', ['ionic', 'citizen-engagement.auth', 'citizen-engagement.constants', 'citizen-engagement.listIssues', 'citizen-engagement.users', "leaflet-directive", "citizen-engagement.map"])
...
$ionicConfigProvider.tabs.position('bottom'); //other values: top
  ...
  $urlRouterProvider.otherwise(function($injector) {
    $injector.get('$state').go('tab.map'); // Go to the new issue tab by default.
  });
